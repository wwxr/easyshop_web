...
public class EasyshopuserQueryDomain extends BaseDomain {
	private static final long serialVersionUID = 1L;
	
	// 分页信息
	private PageParamDomain pageparam = null;
	
	private Easyshopuser easyshopuser = null;
	...
	public Easyshopuser getEasyshopuser() {
		return easyshopuser;
	}

	public void setEasyshopuser(Easyshopuser easyshopuser) {
		this.easyshopuser = easyshopuser;
	}
}
