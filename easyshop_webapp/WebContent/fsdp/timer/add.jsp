...
<div>
	<div class="add-common-head">
    	<div class="add-common-name-add">新建定时器信息<br/></div>
        <input type="button" class="finedo-button-blue" style="float:right" value="提交" onclick="timeradd.doNext();">
    </div>
    ...
    <div id="common_add_div" >
        ...
        <ul>
	    	<li class="add-center"><input type="button" class="finedo-button" value="提    交" onClick="timeradd.dosubmit()" ></li>
	    </ul>
	    <hr></hr>
...
var timeradd={
    checkdata:function() {
     ...
     dosubmit:function() {
         if(!timeradd.checkdata()) 
             return;
         finedo.action.ajaxForm({
             url:"../../finedo/timer/add",
             form:"ajaxForm",
             callback:timeradd.submitcallback
         });
     },
