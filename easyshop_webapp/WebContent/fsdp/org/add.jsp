...
<div>
	<div class="add-common-head">
    	<div class="add-common-name-add">新建组织机构信息<br/>
            <ul>
            	<li id="common_add_card" class="add-link-li">普通新建</li> 
            </ul>
        </div>
        <input type="button" class="finedo-button-blue" style="float:right" value="提交" onclick="orgadd.dosubmit();">
    </div>
    ...
    <div id="common_add_div" >
    	<div class="finedo-nav-title">基本信息</div>
	   	<ul class="finedo-ul">
			<li>
				...
				<input class="finedo-text" type="text" id="parentorgname" name="parentorgname" value="" onclick="orgadd.chooseParentOrg()">
			</li>
			<li>
	    ...
	    <ul>
	    	<li class="add-center"><input type="button" class="finedo-button" value="提    交" onClick="orgadd.dosubmit()" ></li>
	    </ul>
    </div>
    </form>
</div>
    ...
    checkdata:function() {
     ...
     dosubmit:function() {
         ...
         finedo.action.ajaxForm({
             form:"ajaxForm",
             url:"../../finedo/organization/addOrg",
